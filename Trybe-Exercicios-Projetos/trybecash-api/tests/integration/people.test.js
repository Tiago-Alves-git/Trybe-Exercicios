...
describe('testando os endPoints de people', function () {
  ...
  it( 'testando a listagem de pessoas pelo id', async function () {
  ...
  it('testando a alteração de uma pessoa pelo id 1', async function () {
  ...
  it('testando se a pessoa de id 1 foi excluida', async function () {
    sinon.stub(connection, 'execute').resolves([{ affectedRows: 1 }])
    const response = await chai
    .request(app)
    .delete('/people/1');
